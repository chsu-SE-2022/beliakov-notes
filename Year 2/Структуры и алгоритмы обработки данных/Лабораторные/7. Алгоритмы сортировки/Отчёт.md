...
## Сравнение скорости
Debug:
![](Pasted%20image%2020240410142237.png)
Release
![](Pasted%20image%2020240410142430.png)
Предположительная причина: в режиме Release операция обмена оптимизируется с помощью branch prediction