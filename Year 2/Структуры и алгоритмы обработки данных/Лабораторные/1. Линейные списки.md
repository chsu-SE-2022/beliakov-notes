...
impl Stack {  
    fn new(capacity: u32) -> Self {  
        let top = -1;  
        let mut data: Vec<Option<i32>> = Vec::with_capacity(capacity as usize);  
        data.fill(None);  
        Stack {  
            top,  
            data  
        ...
        self.top += 1;  
        self.data.insert((self.top as usize), Some(value));  
    }    fn pop(&mut self) -> i32 {  
        let ret: i32 = self.data.remove((self.top) as usize).unwrap();  
        self.top -= 1;  
        ret  
    }  
