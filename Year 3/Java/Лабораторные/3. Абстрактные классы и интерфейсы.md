...
public interface IFunction {  
    public double SolveInt(double x);  
    public TextArea DisplayInt(double x);  
}
```
## Ellipse.java
```java
        ...
        Button button = new Button("Solve", event -> {
            ...
            switch (types.getValue()) {
                ...
                case "Interface" -> {
                    ...
                    var outputShape = func.DisplayInt(inputX.getValue());
                    output.add(outputShape);
                }
            }
        });
...
```
# Пример
![[Assets/Pasted image 20260117135707.png]]